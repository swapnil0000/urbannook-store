/**
 * inTransit.template.js
 * Sent once when the shipment status transitions to IN_TRANSIT.
 */

const inTransitTemplate = ({
  customerName,
  orderId,
  awbNumber,
  courierCompany,
      ...
      <tr>
        <td align="center" style="padding:44px 48px 16px;">
          ...
          <p style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; color:#666666; line-height:1.75; max-width:420px;">
            Dear <strong style="color:#2E443C; font-weight:600;">${name}</strong>, great news &#8212; your order is currently moving through the courier network and will reach you soon.
          </p>
        </td>
      </tr>
...
export default inTransitTemplate;
